#!/bin/bash
# Training pipeline for contrast-agnostic v3.0.
# Steps:
#   1. Clone datasets from git-annex
#   2. Create datalists (JSON with image/label pairs)
#   3. Convert to nnUNet format (with or without SC bbox crop)
...
# Step to start from (1=clone, 2=datalists, 3=convert, 4=preprocess, 5=train)
START_STEP=3
