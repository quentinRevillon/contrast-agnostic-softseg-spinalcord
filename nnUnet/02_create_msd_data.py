...
def create_df(args, dataset_path):
    ...
    # dcm-brno: exclude DWI labels (reference motion-corrected images absent from raw BIDS)
    # and canal labels (not SC segmentations). Regression from sc-crop-v2/v3 (commit 923e86d).
